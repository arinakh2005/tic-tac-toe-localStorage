class GameMap {
    ...
    constructor(size, numberOfCellsToWin) {
        if (size < minMapSize) {
            ...
            document.getElementById('game-area').value = minMapSize;
            alert(`Мінімальний розмір поля ${minMapSize}х${minMapSize}!`);
        } else if (size > maxMapSize) {
            this.size = maxMapSize;
            document.getElementById('game-area').value = maxMapSize;
        ...
        if (numberOfCellsToWin < minNumberOfCellsForWin) {
            ...
            document.getElementById('number-of-cells-for-win').value = minNumberOfCellsForWin;
            ...
            document.getElementById('number-of-cells-for-win').value = this.size;
